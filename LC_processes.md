...
5) **Разработка конструкции - конструкторских требований к изготовлению  (Design Definition)**
...
6) **Моделирование, анализ и оценка конструкции (System Analysis)**
...
7) **Изготовление компонентов (Implementation)**
...
9) **Проверка выполнения требований (Verification)**
